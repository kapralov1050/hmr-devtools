 ...
 */
import {endpoint} from '@/utils/devLogger/constants';
import {originalFetch, originalXhrOpen, originalXhrSend, sendLog} from '@/utils/devLogger/core';
import {createLog, getStack} from '@/utils/devLogger/helpers';
